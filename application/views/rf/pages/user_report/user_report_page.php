<?php
	$_SESSION['page_name']='user_report_page';
...
$employee_name = isset($employee_name) ? $employee_name : '';
...
<div id="table_box">
	<div class="tables">
		...
		<h1 id="vrai">COUNT</h1>
		<table class="Search">
			<form method="post" action="<?php echo base_url() ?>rf/user_report/user_report_Controller/search_c" >
	...
	<div class="tables">
		...
		<table>
			...
			<tbody>
					...
					if (isset($all_count_out_stock)) 
						{
							...
							foreach ($all_count_out_stock as $result)  
							{
								...
								$employee_name = $result['user_first_name'].' &nbsp; &nbsp;'.$result['user_last_name'];
				...
				<h1 id="vrai"><?php echo $employee_name; ?></h1>
			</tbody>
			</div>	
		</table>
	</div>

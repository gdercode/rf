<?php
class Count_out_stockController extends CI_Controller
{
	public function __construct() // constructor
 	{
	 	...
	 	$needed = $this->session->userdata('count_out_stockpagePermit');
		$this->check_count_out_stock_page_permit($needed);
	}

//--------------------------------------------------------------------------------------------------------------------------------------

	private function check_count_out_stock_page_permit($need)
	{
...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		$data['all_product'] = $this->count_out_stockManager->get_all_product();
		$data['all_count_out_stock'] = $this->count_out_stockManager->get_all_out_prod(); 
		$this->load->view('rf/pages/count_out_stock/count_out_stock_page',$data); // load product page 
	}
//------------------------------------------------------------------------------------------- 
...
//------------------------------------------------------------------------------------------- 
	...
	public function liquid_list_c()   
	{
		...
		$cat = 'Liquid';
		$data['all_product'] = $this->count_out_stockManager->get_all_liquid_product();
		$data['all_count_out_stock'] = $this->count_out_stockManager->get_all_out_prod_by_category($cat);  
		$this->load->view('rf/pages/count_out_stock/count_out_stock_page_category',$data); 
	}
//-------------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	public function solid_kilo_list_c()   
	{
		...
		$cat = 'Solid';
		$data['all_product'] = $this->count_out_stockManager->get_all_kilo_product();
		$data['all_count_out_stock'] = $this->count_out_stockManager->get_all_out_prod_by_category($cat);  
		$this->load->view('rf/pages/count_out_stock/count_out_stock_page_category',$data); 
	}
//-------------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	public function singleItems_list_c()  
	{
		...
		$cat = 'Unit';
		$data['all_product'] = $this->count_out_stockManager->get_all_Unit_product();
		$data['all_count_out_stock'] = $this->count_out_stockManager->get_all_out_prod_by_category($cat);  
		$this->load->view('rf/pages/count_out_stock/count_out_stock_page_category',$data); 
	}
//------------------------------------------------------------------------------------------- 
// ----------------------------------------------------------------------------------------- 
	public function search_c()
	{
		...
		$get_out_date = $this->count_out_stockManager->get_all_out_prod_by_date($out_date1, $out_date2);
		...
		$this->load->view('rf/pages/count_out_stock/count_out_stock_page',$data); 
	}
...
// ----------------------------------------------------------------------------------------- 
	public function search_cat_c()
	{
		...
		$get_out_date = $this->count_out_stockManager->get_all_out_prod_by_date_and_cat($out_date1, $out_date2, $cat);

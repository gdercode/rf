<?php
class refugee_report_Controller extends CI_Controller
{
...
//-----------------------------------------------------------------------------------------------------------------------------------
	...
	{
		$data['all_refugee']=$this->rfManager->get_all_user();
		$this->load->view('rf/pages/refugee_report/refugee_report_page',$data); // load product page 
	}
//------------------------------------------------------------------------------------------- 
// ----------------------------------------------------------------------------------------- 
	public function search_c()
	{
		...
		if ($refugee_id=='none')
		{
			$data['errorSearch']='Select Refugee';
		}
		else
		{
			$get_out_date = $this->count_out_stockManager->get_all_out_prod_to_user($refugee_id, $out_date1, $out_date2);
		...
		$this->load->view('rf/pages/refugee_report/refugee_report_page',$data); 
	}
